...
<!-- The paragraph below is a verbatim copy. Canonical lives in the spec repo's
     README.md; this copy is regenerated by posture/regenerate.py and must never
     be retyped or hand-edited. If you are copying it into another repo, register
     that copy in posture/copies.json in the same change -- an unregistered copy
     is never compared against anything and rots silently. See posture/README.md. -->
